      ...
      <Select open={open} onOpenChange={setOpen} disabled={disabled}>
        <div className="grow flex justify-end items-center self-center">
          <ArcadeMenuButton
            ...
            simplified={true}
            className={cn(
              "bg-background-100 lg:bg-primary-150 hover:bg-background-200 data-[disabled=true]:hover:bg-background-150 text-foreground-300 hover:text-foreground-200 data-[disabled=true]:hover:text-foreground-300 data-[disabled=true]:cursor-default lg:border lg:border-background-200 h-8 w-full flex items-center justify-start gap-1 px-1",
            )}
          >
